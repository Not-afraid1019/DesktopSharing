...
void Overlay::RegisterObserver(OverlayCallback *callback) {
    callback_ = callback;
}
...
bool Overlay::Copy() {
    ...
    int widget_flag = ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoTitleBar;
    ...
    ImGui::RadioButton("x264", &encoder_index_, 1);
    ImGui::SameLine(0, 10);
